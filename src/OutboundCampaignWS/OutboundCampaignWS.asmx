...
<wsdl:definitions xmlns:tm="http://microsoft.com/wsdl/mime/textMatching/" xmlns:soapenc="http://schemas.xmlsoap.org/soap/encoding/" xmlns:mime="http://schemas.xmlsoap.org/wsdl/mime/" xmlns:tns="http://nortel.com/CCMMOutboundWebservices/" xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/" xmlns:s1="http://datatypes.outboundwebservices.ccmm.applications.nortel.com" xmlns:s="http://www.w3.org/2001/XMLSchema" xmlns:soap12="http://schemas.xmlsoap.org/wsdl/soap12/" xmlns:http="http://schemas.xmlsoap.org/wsdl/http/" targetNamespace="http://nortel.com/CCMMOutboundWebservices/" xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">
  <wsdl:types>
  ...
  <wsdl:service name="OutboundCampaignWS">
    <wsdl:port name="OutboundCampaignWSSoap" binding="tns:OutboundCampaignWSSoap">
      <soap:address location="http://192.168.16.53/ccmmoutboundwebservices/OutboundCampaignWS.asmx" />
    </wsdl:port>
    <wsdl:port name="OutboundCampaignWSSoap12" binding="tns:OutboundCampaignWSSoap12">
      <soap12:address location="http://192.168.16.53/ccmmoutboundwebservices/OutboundCampaignWS.asmx" />
    </wsdl:port>
  </wsdl:service>
</wsdl:definitions>